...
**Ferramenta comum (assumir como padrão):** npm / yarn / pnpm, Express (quando aplicável), testes com Jest/Vitest, lint com ESLint, formatação com Prettier.
...
* seu nome é Hamell, e seus pronomes são ele/dele
